...
unit10 = Unit(unit_number="E502", size="Small", rented=False, digital_access=False, type="Parking", renter_id=8, store_id=2)
unit11 = Unit(unit_number="F601", size="Medium", rented=True, digital_access=True, type="Heated", renter_id=11, store_id=2)
unit12 = Unit(unit_number="F602", size="Large", rented=False, digital_access=False, type="Standard", renter_id=6, store_id=2)
unit13 = Unit(unit_number="G701", size="Small", rented=True, digital_access=True, type="Climate Control", renter_id=13, store_id=2)
unit14 = Unit(unit_number="G702", size="Medium", rented=False, digital_access=False, type="Parking", renter_id=5, store_id=2)
unit15 = Unit(unit_number="H801", size="Large", rented=True, digital_access=True, type="Heated", renter_id=1, store_id=2)
unit16 = Unit(unit_number="H802", size="Small", rented=False, digital_access=False, type="Standard", renter_id=4, store_id=2)
unit17 = Unit(unit_number="I901", size="Medium", rented=True, digital_access=True, type="Climate Control", renter_id=3, store_id=2)
unit18 = Unit(unit_number="I902", size="Large", rented=False, digital_access=False, type="Parking", renter_id=3, store_id=2)
unit19 = Unit(unit_number="J1001", size="Small", rented=True, digital_access=True, type="Heated", renter_id=5, store_id=2)
unit20 = Unit(unit_number="J1002", size="Medium", rented=False, digital_access=False, type="Standard", renter_id=2, store_id=2)
