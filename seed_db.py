...
unit2 = Unit(unit_number="A102", size="Medium", rented=True, digital_access=False, type="Parking", renter_id=1, store_id=2)
...
unit10 = Unit(unit_number="E502", size="Small", rented=True, digital_access=False, type="Parking", renter_id=8, store_id=2)
...
unit16 = Unit(unit_number="H802", size="Small", rented=True, digital_access=False, type="Standard", renter_id=4, store_id=2)
unit17 = Unit(unit_number="I901", size="Medium", rented=True, digital_access=True, type="Climate Control", renter_id=3, store_id=2)
unit18 = Unit(unit_number="I902", size="Large", rented=True, digital_access=False, type="Parking", renter_id=3, store_id=2)
