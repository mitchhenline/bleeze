...
renter1 = Renter(first_name = "Mitch", last_name = "Henline", month_of_birth = "August", day_of_birth = 31, year_of_birth = 1974, street_address = "556 Water Street", city = "Tallahasee", state = "Florida", zip = "51323", phone_number = "762-554-0953", email = "rmhenline@gmail.com")
renter2 = Renter(first_name="Catherine", last_name="Major", month_of_birth="April", day_of_birth=12, year_of_birth=1988, street_address="123 Giggles Avenue", city="Los Angeles", state="California", zip="98765", phone_number="555-123-4567", email = "catt@history.com")
renter3 = Renter(first_name="Cesar", last_name="Perez", month_of_birth="February", day_of_birth=29, year_of_birth=1992, street_address="789 Chuckle Road", city="New York", state="New York", zip="12345", phone_number="555-987-6543", email = "f1fan@google.com")
renter4 = Renter(first_name="Nathan", last_name="Searle", month_of_birth="July", day_of_birth=7, year_of_birth=1977, street_address="456 Laughter Lane", city="Miami", state="Florida", zip="54321", phone_number="555-789-1234", email = "nsearle@hotmail.com")
renter5 = Renter(first_name="Jon", last_name="Luker", month_of_birth="December", day_of_birth=25, year_of_birth=1985, street_address="321 Chuckle Street", city="Chicago", state="Illinois", zip="13579", phone_number="555-456-7890", email = "jonnygames@gmail.com")
renter6 = Renter(first_name="Blake", last_name="White", month_of_birth="May", day_of_birth=16, year_of_birth=1990, street_address="567 Guffaw Avenue", city="Houston", state="Texas", zip="56789", phone_number="555-234-5678", email = "scubadoo@hotmail.com")
renter7 = Renter(first_name="Paul", last_name="Nisonger", month_of_birth="September", day_of_birth=3, year_of_birth=1983, street_address="234 Giggles Lane", city="San Francisco", state="California", zip="98765", phone_number="565-876-5432", email = "pauln@gmail.com")
renter8 = Renter(first_name="Alex", last_name="Sylvester", month_of_birth="March", day_of_birth=8, year_of_birth=1978, street_address="890 Chuckle Road", city="Denver", state="Colorado", zip="54321", phone_number="555-765-4321", email = "tippick@gamingworld.com")
renter9 = Renter(first_name="Chad", last_name="Atkinson", month_of_birth="June", day_of_birth=19, year_of_birth=1995, street_address="432 Laugh Lane", city="Seattle", state="Washington", zip="24680", phone_number="555-654-3210", email = "chadatty@hotmail.com")
renter10 = Renter(first_name="Tyler", last_name="Gerrard", month_of_birth="October", day_of_birth=10, year_of_birth=1980, street_address="111 Guffaw Street", city="Phoenix", state="Arizona", zip="13579", phone_number="555-321-6543", email = "tgnetworking@dundermifflin.com")
renter11 = Renter(first_name="Mike", last_name="Palmer", month_of_birth="April", day_of_birth=1, year_of_birth=1989, street_address="222 Chuckle Avenue", city="Philadelphia", state="Pennsylvania", zip="98765", phone_number="555-987-1234", email = "bossguy@extraspace.com")
renter12 = Renter(first_name="Austin", last_name="Taylor", month_of_birth="January", day_of_birth=5, year_of_birth=1991, street_address="333 Giggles Street", city="Atlanta", state="Georgia", zip="54321", phone_number="555-456-7890", email = "tayloraus@askjeeves.com")
renter13 = Renter(first_name="Stanley", last_name="Rimer", month_of_birth="August", day_of_birth=20, year_of_birth=1987, street_address="444 Guffaw Lane", city="Dallas", state="Texas", zip="13579", phone_number="555-123-6543", email = "rimeguy@gmail.com")
renter14 = Renter(first_name="Devvin", last_name="Kraatz", month_of_birth="November", day_of_birth=11, year_of_birth=1982, street_address="555 Chuckle Street", city="Miami", state="Florida", zip="24680", phone_number="555-789-0123", email = "kraatzman@hotmail.com")
